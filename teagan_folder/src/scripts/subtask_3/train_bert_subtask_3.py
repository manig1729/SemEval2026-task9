...
TRAIN_CSV = f"/projects/tejo9855/Projects/SemEval2026-task9/teagan_folder/src/preprocessed_data/subtask_3_test/{MODEL_NAME}/train_{MODEL_NAME}.csv" 
VAL_CSV   = f"/projects/tejo9855/Projects/SemEval2026-task9/teagan_folder/src/preprocessed_data/subtask_3_test/val_subtask_3.csv" 
          
OUTPUT_DIR = f"/projects/tejo9855/Projects/SemEval2026-task9/teagan_folder/src/models/subtask_3_test/{MODEL_NAME}_model"
...
def main():
    ...
    train_dataset = MultiLabelDataset(
        train_df,
        tokenizer=tokenizer,
        label_cols=SUBTASK3_LABEL_COLS,
    ...
    num_labels = len(SUBTASK3_LABEL_COLS)
