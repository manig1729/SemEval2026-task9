...
DEV_CSV  = "/projects/tejo9855/Projects/SemEval2026-task9/teagan_folder/src/preprocessed_data/subtask_3/val_subtask_3.csv"
...
def main():
    ...
    for label_idx, label_name in enumerate(SUBTASK3_LABEL_COLS):
