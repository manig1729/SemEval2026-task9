...
OUTPUT_CSV = "/projects/tejo9855/Projects/SemEval2026-task9/predictions/subtask_3/pred_eng_masked.csv"
...
def main():
    ...
    if preds.shape[1] != len(SUBTASK3_LABEL_COLS):
        raise ValueError(
            f"Model outputs {preds.shape[1]} labels but expected "
            f"{len(SUBTASK3_LABEL_COLS)}. Check model training."
        )
